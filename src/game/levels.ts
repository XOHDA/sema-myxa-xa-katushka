...
export const LEVELS: Record<LevelId, LevelConfig> = {
  ...
  3: {
    id: 3,
    name: RU.level3Name,
    subtitle: 'Контейнеры, трубы, металлоконструкции и мелкий моросящий дождь',
    theme: 'industrial',
    weather: 'light-rain',
    length: 19200,
    gravity: 1240,
  ...
  6: {
    id: 6,
    name: RU.level6Name,
    subtitle: 'Глубокие лужи, воблинг на мокром асфальте и проливной ливень',
    theme: 'storm',
    weather: 'heavy-rain',
    length: 22800,
    gravity: 1270,
  ...
  8: {
    id: 8,
    name: RU.level8Name,
    subtitle: 'Заснеженное шоссе, гололёд, пушистый снегопад и занос на поворотах',
    theme: 'sunset-highway',
    weather: 'snow',
    length: 25200,
    gravity: 1290,
  ...
  10: {
    id: 10,
    name: RU.level10Name,
    subtitle: 'Подземные своды, сырость и капли с потолка на 115+ км/ч',
    theme: 'cyber',
    weather: 'light-rain',
    length: 27600,
    gravity: 1310,
  ...
  11: {
    id: 11,
    name: RU.level11Name,
    subtitle: 'Ледяной мост, шквальная метель, встречный ветер и гололедица',
    theme: 'storm',
    weather: 'blizzard',
    length: 28800,
    gravity: 1320,
  ...
  12: {
    id: 12,
    name: RU.level12Name,
    subtitle: 'Кибер-зима: заснеженная магистраль и реактивный темп',
    theme: 'cyber',
    weather: 'snow',
    length: 30000,
    gravity: 1330,
  ...
  13: {
    id: 13,
    name: RU.level13Name,
    subtitle: 'Ночной шторм и ливень, дрифт на 130+ км/ч в неоновых лужах',
    theme: 'night-neon',
    weather: 'heavy-rain',
    length: 31500,
    gravity: 1340,
  ...
  14: {
    id: 14,
    name: RU.level14Name,
    subtitle: 'Снежный буран на грани продава! Ледяное покрытие на 145+ км/ч',
    theme: 'sunset-highway',
    weather: 'blizzard',
    length: 33000,
    gravity: 1350,
  ...
  15: {
    id: 15,
    name: RU.level15Name,
    subtitle: 'Ультимативный заезд VOLTARZ: максимум скорости до 150 км/ч под грозовым ливнем!',
    theme: 'cyber',
    weather: 'heavy-rain',
    length: 36000,
    gravity: 1360,
